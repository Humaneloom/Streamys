...
const StudentSideBar = ({ isCollapsed = false }) => {
    ...
    const menuItems = [
        ...
        { path: "/Student/marksheets", icon: <GradeIcon />, text: "Marksheets" },
        { path: "/Student/attendance", icon: <ClassOutlinedIcon />, text: "Attendance" },
        { path: "/Student/fee-payment", icon: <PaymentIcon />, text: "Fee Payment" },
        { path: "/Student/complain", icon: <AnnouncementOutlinedIcon />, text: "Complain" },
        { path: "/Student/testpapers", icon: <AssignmentIcon />, text: "Test Papers" },
        { path: "/Student/progressreport", icon: <AssessmentIcon />, text: "Progress Report" },
        { path: "/Student/assessmenttools", icon: <BarChartIcon />, text: "Assessment Tools" },
        { path: "/Student/doubts", icon: <AnnouncementOutlinedIcon />, text: "Doubts & Queries" },
        { path: "/Student/interactions", icon: <ChatIcon />, text: "Teacher Interactions" },
        { path: "/Student/schedule-edit", icon: <ScheduleIcon />, text: "My Schedule" },
        { path: "/Student/exam-timetables", icon: <EventNoteIcon />, text: "Exam Timetables" },
        { path: "/Student/library", icon: <LocalLibraryIcon />, text: "Library" },
    ];
