...
import { getStudentBookLoans } from '../../redux/bookLoanRelated/bookLoanHandle';
...
const StudentLibrary = () => {
  ...
  // Fetch student's book loans when component mounts
  useEffect(() => {
    if (currentUser && currentUser._id) {
      console.log('Fetching book loans for student:', currentUser._id);
      dispatch(getStudentBookLoans(currentUser._id));
    } else {
  ...
  return (
    <Box sx={{ 
      ...
      <Box sx={{ mb: 4 }}>
        ...
        >
          Welcome back, {currentUser?.name || 'Student'}! Here's your library overview.
        </Typography>
      </Box>
