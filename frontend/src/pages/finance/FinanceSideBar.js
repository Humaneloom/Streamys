...
const FinanceSideBar = ({ isCollapsed = false }) => {
    ...
    const menuItems = [
        ...
        { path: "/Finance/fees", icon: <AttachMoneyIcon />, text: "Fee Management" },
        { path: "/Finance/student-fees", icon: <SchoolIcon />, text: "Student Fees" },
        { path: "/Finance/other-expenses", icon: <ReceiptIcon />, text: "Other Expenses" },
        { path: "/Finance/teachers", icon: <PersonIcon />, text: "Teacher Salaries" },
        { path: "/Finance/reports", icon: <AssessmentIcon />, text: "Reports" },
    ];

    const userMenuItems = [
        { path: "/Finance/profile", icon: <AccountCircleOutlinedIcon />, text: "Profile" },
