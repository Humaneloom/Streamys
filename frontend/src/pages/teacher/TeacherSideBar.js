...
import {
    Divider, ListItemButton, ListItemIcon, ListItemText, Box, Typography, Avatar, Tooltip, Dialog, DialogTitle, DialogContent, DialogActions, Button, ListSubheader
} from '@mui/material';
...
const TeacherSideBar = ({ isCollapsed = false }) => {
    ...
    const menuItems = [
        ...
        { path: '/Teacher/class', icon: <ClassOutlinedIcon />, text: 'Classes' },
        { path: '/Teacher/marksheet-review', icon: <GradeIcon />, text: 'Marksheet Review' },
        { path: '/Teacher/doubts', icon: <AnnouncementOutlinedIcon />, text: 'Doubts & Queries' },
        { path: '/Teacher/interactions', icon: <ChatIcon />, text: 'Student Interactions' },
        { path: '/Teacher/library', icon: <LibraryBooksIcon />, text: 'Library' },
        { path: '/Teacher/complain', icon: <AnnouncementOutlinedIcon />, text: 'Complain' },
        { path: '/Teacher/schedule-edit', icon: <ClassOutlinedIcon />, text: 'Edit Schedule' },
        { path: '/Teacher/assessment', icon: <AssignmentOutlinedIcon />, text: 'Assessment & Evaluation' },
        { path: '/Teacher/exam-timetables', icon: <EventNoteIcon />, text: 'Exam Timetables' },
    ];

    const userMenuItems = [
        { path: '/Teacher/profile', icon: <AccountCircleOutlinedIcon />, text: 'Profile' },
